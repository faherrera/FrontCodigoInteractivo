...
//UI MATERIALIZE
import { Table, Button, Icon, CollectionItem,Collection} from 'react-materialize';
...
export default class List extends Component {
    ...
    render() {
        ...
        let Enrollment = this.state.enrollment.filter(item => {
            if (!item.Access) {
                return item;
            }
        }).map(item => item);
        ...
        if (!Enrollment.length) {
            return(
                <Collection header='Inscripciones con pago pendiente '>
